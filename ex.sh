...
# CIL CONFIG
NOTE="baseline_wo_neck_disjoint_cifar10_mem500_iter_1_collapse_check" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="baseline"
K_COEFF="4"
TEMPERATURE="0.125"
