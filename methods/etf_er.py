...
class ETF_ER(CLManagerBase):
    ...
    def online_step(self, sample, sample_num, n_worker):
        ...
        if self.sample_num % 100 == 0 and self.sample_num !=0:
            ...
            fc_pickle_name = "etf_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_fc.pickle"
            ...
            feature_pickle_name = "etf_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_feature.pickle"
            class_pickle_name = "etf_num_" + str(self.sample_num) + "_iter" + str(self.online_iter) + "_class.pickle"
